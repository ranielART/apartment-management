                                        ...
                                        <?php foreach ($histories as $history): ?>
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <a href="/paymentHistory?history_id=<?= $history['bill_id'] ?>&view_history_modal=true"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="flex justify-between p-6">
                                                                        <div class="flex flex-col gap-y-6">
                                                                            <label class="text-gray-400">PIC: </label>
                                                                            <label class="text-gray-400">Unit Number: </label>
                                                                            <label class="text-gray-400">Tenant Name: </label>
                                                                            ...
                                                                            <label class="text-gray-400">Date Paid: </label>
                                                                        ...
                                                                        <div class="flex flex-col gap-y-6">
                                                                            <label
                                                                                class="text-gray-400"><?= $history['name'] ?></label>
                                                                            <label
                                                                                class="text-gray-400"><?= $history['unit_number'] ?></label>
                                                                            <label
                                                                                class="text-gray-400"><?= $history['tenant_name'] ?></label>
                                                                            <label
                                                                                class="text-gray-400"><?= $history['issue_date'] ?></label>
                                                                            <label class="text-gray-400">
                                                                                <?= $history['billing_period_start'] ?></label>
                                                                            <label
                                                                                class="text-gray-400"><?= $history['due_date'] ?></label>
                                                                            <label
                                                                                class="text-gray-400">₱<?= $history['unit_bill'] ?></label>
                                                                            <label
                                                                                class="text-gray-400">₱<?= $history['utilities_bill'] ?></label>
                                                                            <label
                                                                                class="text-gray-400">₱<?= $history['payment_date'] ?></label>
                                                                            <label
                                                                                class="text-gray-400 font-bold">₱<?= $history['total_bill'] ?></label>
