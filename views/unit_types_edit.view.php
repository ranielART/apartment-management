        ...
        <div x-show="isFeedbackOpen = <?= $_GET['unit_add_msg'] ?>" x-cloak
            ...
            <div class="flex items-center justify-center min-h-screen px-4 text-center sm:p-0">
                ...
                <div
                    ...
                    <label class="text-md text-green-400 mb-5" for="floorNumber">Unit Type Added
                        Successfully!</label>
        ...
        <div class="bg-gray-950 rounded-md p-6">
            <form method="POST">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="number" name="bathrooms" id="bathrooms" placeholder="Total Bathrooms"
                                        min="0" value="<?= $unitType['total_bathrooms'] ?? '' ?>"
                ...
                <div class="mt-6 flex items-center justify-end gap-x-6">
                    ...
                    <button type="submit" name="updateType"
                        class="min-w-10 flex font-medium px-6 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-600 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-sky-500 ">Update
                        Type</button>
                </div>
            </form>
        </div>
